...
// Get user and room IDs for reservations
...
// Create reservations with various statuses and times
$currentDate = date('Y-m-d');
$sampleReservations = [
    // Past reservations (accepted)
    ...
    // Future reservations (various statuses)
    ...
    // Some rejected/cancelled reservations
...
foreach ($sampleReservations as $reservation) {
    // Ensure we have valid room and user IDs
