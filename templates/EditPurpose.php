  ...
  <div class="bg-blue-50 border border-blue-200 rounded-md p-4">
    <div class="flex items-center">
      ...
      <span class="text-sm text-blue-800">
        This purpose is currently used by <strong><?php echo $usageCount; ?></strong>
        reservation<?php echo $usageCount !== 1 ? 's' : ''; ?>
      </span>
    </div>
  </div>
  <div>
    <label for="name" class="block mb-1 font-medium text-gray-700">Purpose Name *</label>
    <input id="name" name="name" type="text" required value="<?php echo htmlspecialchars($purpose['name']); ?>"
      ...
      <div class="flex">
        ...
        <div class="ml-3">
          ...
          <div class="mt-2 text-sm text-yellow-700">
            <p>Changes to this purpose will affect all <?php echo $usageCount; ?>
              reservation<?php echo $usageCount !== 1 ? 's' : ''; ?> that use this purpose. If you change the approval
              requirement, it will apply to future reservations only.</p>
          </div>
        </div>
      </div>
    </div>
