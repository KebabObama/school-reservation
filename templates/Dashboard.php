...
<div class="space-y-6">
  ...
  <div class="bg-gradient-to-r from-blue-600 to-blue-800 rounded-lg p-6 text-white">
    <h1 class="text-3xl font-bold mb-2">Welcome back, <?php echo $user_name . ' ' . $user_surname; ?>!</h1>
    <p class="text-blue-100">Here's what's happening with your room management system today.</p>
  </div>
          ...
          <?php foreach ($todayReservations as $reservation): ?>
            <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
              <div>
                ...
                <p class="text-sm text-gray-600"><?php echo htmlspecialchars($reservation['user_name'] . ' ' . $reservation['user_surname']); ?></p>
              </div>
              <div class="text-right">
                <p class="text-sm font-medium text-gray-900"><?php echo date('H:i', strtotime($reservation['start_time'])); ?></p>
