...
try {
  ...
  // Fetch buildings and floors for location dropdown
  $locations = $pdo->query("
...
<script>
  ...
  // Optional fields - no validation needed for description and equipment

  // Locations are now loaded via PHP, no need for dynamic loading
