...
if (!canViewBuildings($userData['user_id']) && !hasPermission($userData['user_id'], 'buildings_create') && !hasPermission($userData['user_id'], 'floors_create') && !hasPermission($userData['user_id'], 'rooms_create')) {
